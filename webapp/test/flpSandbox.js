			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devfacturas-display": {
								"semanticObject": "devfacturas",
								"action": "display",
								"description": "Facturas Proveedores",
								"title": "Facturas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dev.facturas",
									"url": sap.ui.require.toUrl("dev/facturas")
								}
							}
						}
					}
